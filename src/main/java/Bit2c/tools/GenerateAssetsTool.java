...
//
//    @SneakyThrows
//    private static void createEnum(AssetPairsEnum.AssetPairs assetPairs) {
...
//                .build();
//        JavaFile javaFile = JavaFile.builder("Kraken.entities", assetEnums).build();
//        System.out.println("Creating AssetPairsEnum.java file under Kraken.entities...");
